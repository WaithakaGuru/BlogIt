...
import { useGetAllBlogs, useGetCurrentUserInfo} from "../service/FetchAllBlogs";
      ...
      >
        <Box
          ...
          <Typography
            ...
            <IconButton title="Edit Profile" href="/dashboard/profile"><Edit sx={{position: "relative", right:0, cursor: "pointer", color:" #fff", bgcolor: "darkslateblue", borderRadius: "50%", height:"3rem", width: "3rem"}}/></IconButton>
        </Box>
