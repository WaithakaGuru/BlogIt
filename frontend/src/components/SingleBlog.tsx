...
function SingleBlog(blog:BlogType ) {
  return(
      <Card sx={{height: "max-content", width: {xs: "95%", sm: "85%", md: "65%"},
       mx: "auto", my:2, p:1}} elevation={5}>
        <CardMedia component={"img"}  image={blog?.featuredImageURL}  width={"100%"} sx={{maxHeight: "20rem"}}/>
